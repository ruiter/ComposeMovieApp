...
fun getMovies() = listOf<Movie>(
    Movie(
        ...
        plot = "A couple of recently deceased ghosts contract the services of a  in order to remove the obnoxious new owners of their house.",
